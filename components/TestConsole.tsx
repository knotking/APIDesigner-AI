                        ...
                        <div key={param.name} className="grid grid-cols-12 gap-4 items-center group">
                            ...
                            <div className="col-span-8 relative">
                                <input 
                                    ...
                                    placeholder={param.example ? `e.g. ${param.example}` : `Value for ${param.name}`}
            ...
            <div className="h-full flex flex-col p-6">
                <div className="text-xs text-slate-500 mb-2 flex justify-between">
                    ...
                    <div className="flex gap-2">
                        <button onClick={handleMagicFill} className="text-indigo-400 hover:text-indigo-300 flex items-center gap-1">
                             <Sparkles className="w-3 h-3" /> Generate Example
                        </button>
                        <button onClick={() => setJsonBody(JSON.stringify(JSON.parse(jsonBody), null, 2))} className="text-slate-400 hover:text-slate-300">
                             Prettify
                        </button>
                    </div>
                </div>
        ...
        <div className="p-6 border-t border-slate-800 bg-slate-900/30 flex items-center gap-3 relative z-20">
            <div className="flex-1 flex gap-2">
                ...
                >
                    ...
                    {loading ? 'Simulating Response...' : 'Execute Request'}
                </button>

                <button 
                    onClick={handleMagicFill}
                    className="px-4 bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 rounded-lg flex items-center gap-2 transition-colors"
                    title="Magic Fill: Auto-populate all fields with mock data"
                >
